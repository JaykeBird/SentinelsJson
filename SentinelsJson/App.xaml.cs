    ...
    public partial class App : Application
    {
        public App()
        {
            ...
            if (Directory.Exists(appDataPath))
            {
                ...
                {
                    MessageBox.Show("The settings file for SentinelsJson could not be found or accessed. SentinelsJson will continue with default settings. Please check the permissions for your AppData folder.",
            ...
            else
            {
                ...
                {
                    MessageBox.Show("The settings file could not be created for SentinelsJson. Please check the permissions for your AppData folder.",
                        "Settings Error", MessageBoxButton.OK, MessageBoxImage.Error);
                }
                catch (System.Security.SecurityException)
                {
        ...
        #region Constants
        public static Version AppVersion = new Version("0.8");
        ...
        private async void Application_DispatcherUnhandledException(object sender, System.Windows.Threading.DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            MessageBox.Show("An error has occurred and SentinelsJson may not be able to continue.\n\n" +
                "An error log file was created.\n\n" +
                "Please go to SentinelsJson GitHub website to report the error.",
                "SentinelsJson Error Occurred", MessageBoxButton.OK, MessageBoxImage.Error);
        }
