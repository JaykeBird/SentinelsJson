...
namespace SentinelsJson
{
    public static class UpdateChecker
    {
        ...
        public static async Task<UpdateData> CheckForUpdatesAsync()
        {
            ...
            string s = await wc.DownloadStringTaskAsync("https://api.github.com/repos/JaykeBird/SentinelsJson/releases/latest");
    ...
    public class UpdateData
    {
        ...
        public string Url { get; set; } = "https://github.com/JaykeBird/SentinelsJson/releases";
